...
function Home() {
  ...
  function handleSubmit(e) {
    ...
    axios
      .post(`https://api.shrtco.de/v2/shorten?url=${original}`)
      .then((res) => {
        if (res.data.ok) {
          var listItem = {
            id:
